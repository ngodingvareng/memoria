...
// These exercise middleware.RequireOnboarded end to end via /threads (an
...
func TestRequireOnboarded_ActivityRoute_BlocksAccountWithoutUsername(t *testing.T) {
...
func TestRequireOnboarded_ActivityRoute_AllowsAccountWithUsername(t *testing.T) {
	testApp := setupTestApp(t)
...
func TestRequireOnboarded_UsernameAvailability_ExemptForAccountWithoutUsername(t *testing.T) {
	testApp := setupTestApp(t)
	userID := seedTestUserWithoutUsername(t, testApp.pool)
...
func TestRequireOnboarded_SetUsername_ExemptForAccountWithoutUsername(t *testing.T) {
	testApp := setupTestApp(t)
	userID := seedTestUserWithoutUsername(t, testApp.pool)
...
func TestRequireOnboarded_GetMe_BlocksAccountWithoutUsername(t *testing.T) {
	testApp := setupTestApp(t)
	userID := seedTestUserWithoutUsername(t, testApp.pool)
