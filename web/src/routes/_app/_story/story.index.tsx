    ...
    capture: {
      ...
      content: (
        <div className="flex flex-col gap-3">
          <p>
            Perjalanan panjang dan melelahkan terbayar lunas saat melihat
            matahari terbit dari puncak Rinjani. Sungguh pengalaman magis yang
            tak terlupakan! 🏔️✨
          </p>
          <img
  ...
  },
  {
    capture: {
      ...
      content: (
        <div>
          <p>
            Pecah banget malam ini! Berhasil dapet posisi paling depan dan
            nyanyi bareng dari awal sampai akhir. Suara udah habis tapi{' '}
    ...
    capture: {
      ...
      content: (
        <div className="space-y-2">
          <p>
            Hari ini mencoba membuat <b>Beef Wellington</b> untuk pertama
            kalinya. <i>Pastry</i>-nya renyah dan dagingnya matang sempurna
            medium rare! 🥩🔥 Ada yang mau resepnya?
          </p>
          <img
  ...
  },
  {
    capture: {
      ...
      content: (
        <div>
          <p>
            Momen <i>Clutch 1v5</i> yang mengamankan tiket tim kami ke babak
            Final besok! Tangan masih gemeteran tapi GGWP untuk semua tim yang
            bertanding hari ini. 🎮🏆
          </p>
        </div>
      ),
      ...
      content: (
        <div className="flex flex-col gap-2">
          <p>
            ...
            menenangkan pikiran sebelum menghadapi hari Senin besok. Namaste
            🙏🧘‍♀️
          </p>
        </div>
      ),
